...
function showResult(percentage, ca) {
	if (ca == 5) {
		RColor = 'teal';
		resultFb.innerHTML = 'Wohoo.. Very Strong';
		correctAns.innerHTML = 'Correct Answers: ' + ca+"/5";
	} else if (ca==4) {
		RColor = 'green';
		resultFb.innerHTML = 'Strong.';
		correctAns.innerHTML = 'Correct Answers: ' + ca+"/5";
	} else if (ca == 3) {
		RColor = 'blue';
		resultFb.innerHTML = 'Good.';
		correctAns.innerHTML = 'Correct Answers: ' + ca+"/5";
	} else if (ca >= 2) {
		RColor = 'orange';
		resultFb.innerHTML = 'BAD';
		correctAns.innerHTML = 'Correct Answers: ' + ca+"/5";
	} else if (ca >= 2) {
		RColor = 'orange';
		resultFb.innerHTML = 'Poor';
		correctAns.innerHTML = 'Correct Answers: ' + ca+"/5";
        }else {
		RColor = 'red';
